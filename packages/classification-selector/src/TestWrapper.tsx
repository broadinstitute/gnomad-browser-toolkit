...
import { Grid, Typography, ThemeProvider, createMuiTheme, Container } from 'mui/material'
...
const { selectedItemsContainerCypressDataAttr, numFilteredItemsCypressDataAttr } =
