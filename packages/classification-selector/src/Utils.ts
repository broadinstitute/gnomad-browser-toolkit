...
export type HierarchicalIdGeneratorInputs = {
  ...
  {type: "category",  category: string, level: number} |
  {type: "classification"}
)

// This assumes that the $ character doesn't appear in any word:
export const generateNodeId = (input: SimpleNodeIdGeneratorInputs | HierarchicalIdGeneratorInputs): string => {
...
export const parseNodeId = (input: string): SimpleNodeIdGeneratorInputs | HierarchicalIdGeneratorInputs => {
