...
const hierarchicalClassifications = [
  {
    ...
    categories: [
      ...
      {path: ["category 2-1--1", "category 2-2--1", "category 2-3--2", "category 2-4--1"], itemCount: 1},
    ],
...
const items = [
  {
    name: "item a", simpleCategory: "simple category 1",
    hierarchicalClassification: ["category 1-1--1"]
  },
  {
    name: "item b", simpleCategory: "simple category 1",
    hierarchicalClassification: ["category 1-1--2", "category 1-2--1"]
  },
  {
    name: "item c", simpleCategory: "simple category 1",
    hierarchicalClassification: ["category 1-1--2", "category 1-2--2"]
  },
  {
    name: "item d", simpleCategory: "simple category 2",
    hierarchicalClassification: ["category 1-1--2", "category 1-2--3", "category 1-3--1"]
  },
  {
    name: "item e", simpleCategory: "simple category 3",
    hierarchicalClassification: ["category 1-1--2", "category 1-2--3", "category 1-3--2"]
  },
  {
    name: "item f", simpleCategory: "simple category 1",
    hierarchicalClassification: ["category 2-1--1", "category 2-2--1", "category 2-3--2", "category 2-4--1"]
  },
  {
    name: "item g", simpleCategory: "simple category 2",
    hierarchicalClassification:  ["category 1-1--1"]
  },
  {
    name: "item h", simpleCategory: "simple category 3",
    hierarchicalClassification: ["category 1-1--2", "category 1-2--1"]
  },
  {
    name: "item i", simpleCategory: "simple category 1",
    hierarchicalClassification: ["category 1-1--2", "category 1-2--2"]
  },
  {
    name: "item j", simpleCategory: "simple category 2",
    hierarchicalClassification: ["category 1-1--2", "category 1-2--3", "category 1-3--1"]
  }
]
...
export const multipleClassifications = () => (
  <TestWrapper items={items} classifications={[...hierarchicalClassifications, ...simpleClassifications]}/>
)
...
const selectAllSelectNoneSimpleClassificationItems = [
  ...
  {
    name: "item b", simpleCategory: "simple category 2",
  },
  {
    name: "item c", simpleCategory: "simple category 3",
  },
]
