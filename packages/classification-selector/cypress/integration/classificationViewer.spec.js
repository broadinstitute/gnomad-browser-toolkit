...
describe("Simple classification", () => {
  ...
  it("Select a single category", () => {
    cy.getIframeBody().within(() => {
      cy.get(attr(classificationTreeItemCypressDataAttr)).as("classification").contains("simple classification").click()
...
describe("Hierarchical classification", () => {
  ...
  it("Select a single category at level 1", () => {
    cy.getIframeBody().within(() => {
      cy.get(attr(classificationTreeItemCypressDataAttr)).as("classification").contains("hierarchical classification").click()
...
describe("multiple classifications", () => {
  ...
  it("should not allow categories across different classifications to be selected", () => {
    ...
    cy.getIframeBody().within(() => {
      ...
      cy.get(attr(classificationTreeItemCypressDataAttr)).contains("hierarchical classification").click()
